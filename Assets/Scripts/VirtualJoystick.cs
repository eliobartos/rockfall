...
using UnityEngine.EventSystems; // Get access to event interfaces
using UnityEngine.UI; // Get access to UI elements
...
public class VirtualJoystick : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    // The distance that the thumb has been dragged away from its original position
    ...
    public void OnBeginDrag (PointerEventData eventData) {
        ...
        // Place the jojstick at that pooint
        this.GetComponent<RectTransform>().position = worldPoint;

        // Ensure that the thumb is in its original location, relative to the jojstick (0, 0)
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        // Reset the position of the jojstick
